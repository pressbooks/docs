...
The Pressbooks command line interface is now part of Pressbooks. Want to make your own book theme? Run `wp scaffold book-theme` from the root of your Pressbooks install and take advantage of our intuitive SCSS-based theme structure. More commands to come -- [submit your ideas][9]!

#### Detailed Changelog

*   **Feature:** REST API v2 (see #472, #763, #770, #771, #774, #778, #780, #781, #783, #785, #788, #798, #803, #804, #806, #807, #810, #812, #815, #816, #823, #832, and our [API Docs][8]
...
*   **Enhancement:** Additional post types can be added to the list of permitted post types for editing using the [`pb_supported_post_types` filter][18] (props to @steelwagstaff, see #758).
*   **Enhancement:** We now use [vanilla/htmlawed][19] as our htmLawed provider (see #767).
...
**NOTICE:** Pressbooks now requires [WordPress 4.7.5][20].
...
*   **Fix:** Switched to an unmodified version of htmLawed to fix a regression in [vanilla/htmlawed][21] which was stripping paragraph tags from blockquotes (see #723).
...
*   **Enhancement:** [perchten/rmrdir][22] is now used for recursive directory removal (see [37ab804][23]).
*   **Enhancement:** Added \Pressbooks\Utility\rcopy() function for recursive directory copying (props to @blobaugh for the [example code][24]; see [52b087b][25]).
...
**NOTICE:** Pressbooks now requires [WordPress 4.7.3][26]. * **Enhancement:** Streamlined and refactored the running content SCSS partials for SCSS-based themes (see #675 and #686).
...
**NOTICE:** Pressbooks now requires [WordPress 4.7.2][27].
...
*   **Enhancement:** Javascript and SCSS files are now validated on pull requests using [Hound][28] (see #617).
...
**NOTICE:** Pressbooks now requires [WordPress 4.7 "Vaughan"][29].

**NOTICE:** Pressbooks now requires [PrinceXML 11][30] for PDF exports.
...
*   **Feature:** Added Hindi language support using [Noto Sans Devanagari][31] and [Noto Serif Devanagari][32].
...
*   **Enhancement:** Added the ability to retry asset fetching during EPUB export in the event of server errors (props to @nathanielks, see [7344674][33])
*   **Enhancement:** Added filter and action hooks to support the addition of import modules via third-party plugins (props to @monkecheese, see [4d7ca64][34]).
...
*   **Enhancement:** Added [`pb_cover_image`][35] filter to improve support for networks which host uploaded content on a third-party server (props to @monkecheese).
...
*   **Feature:** Pressbooks + Hypothesis: Version 0.4.8 of the [Hypothesis][36] WordPress plugin now supports custom post types, and Pressbooks 3.9.4 adds Hypothesis support to all of ours (parts, chapters, front and back matter).
...
*   **NOTE:** [Saxon-HE 9.7.0-10][37] is no longer bundled with Pressbooks and must be installed separately for ODT export support (see [Installation][38]).
...
*   **NOTE:** Pressbooks 3.9.2 requires [PrinceXML 20160929][39] or later.
*   **Fix:** Fixed an issue where user actions on the Organize page would fail to update certain properties.

### 3\.9.2

*   **NOTE:** Pressbooks 3.9.2 requires [PrinceXML 20160929][39] or later.
*   **Feature:** Added an export format for print-ready PDF, compatible with the [CreateSpace PDF Submission Specification][40] (**Requires [PrinceXML 20160929][39] or later**).
...
*   **Enhancement:** Applied our [coding standards][41] across the board and added PHP_CodeSniffer to our CI routines.
...
*   **Enhancement:** Added initial support for SVG LaTeX images in PDF exports (requires [QuickLaTex][42]).
...
*   **Feature:** The redistribution option from [Pressbooks Textbook][43], which allows a book administrator to share the latest export files of their book on the webbook cover page, has been migrated into Pressbooks and can be found under (Network) Settings -> Sharing and Privacy. Many thanks to @bdolor for developing this feature (and fixing a display bug in our implementation of it).
...
*   **Enhancement:** [Hypothesis][44] has been added to the supported plugins list, and the supported plugins list is now built more intelligently.
...
*   **Enhancement:** Added support for testing PrinceXML's built-in [PDF profile][45] support by setting the `PB_PDF_PROFILE` constant to the desired profile.
...
*   FIXED: The Tweet button had stopped working, so we replaced our previous sharing script with @ellisonleao's excellent [sharer.js][46].
...
*   Internal dependencies are now managed using [Composer][47].
...
*   Moved the mPDF library to an external plugin, [Pressbooks mPDF][48].
...
*   New root theme, Pressbooks Publisher 2.0. Pressbooks Publisher One has been deprecated and is now available (unsupported) [here][49].
...
*   Ebook theme option to skip line between paragraphs is now honored in all themes.
 ...
 [12]: https://engineering.hmn.md/how-we-work/style/php/
 [13]: http://docs.pressbooks.org/coding-standards/#validating-with-php-code-sniffer
 [14]: https://github.com/jeffreyway/laravel-mix
 [15]: https://yarnpkg.com
 [16]: https://stylelint.io
 [17]: http://docs.pressbooks.org/upgrading
 [18]: https://github.com/pressbooks/pressbooks/blob/4.0.0/inc/posttype/namespace.php#L16-L29
 [19]: https://packagist.org/packages/vanilla/htmlawed
 [20]: https://wordpress.org/news/2017/05/wordpress-4-7-5/
 [21]: https://github.com/vanilla/htmlawed/
 [22]: https://packagist.org/packages/perchten/rmrdir
 [23]: https://github.com/pressbooks/pressbooks/commit/37ab804489c580ad1d1121c0a07144f37772c7d0
 [24]: http://ben.lobaugh.net/blog/864/php-5-recursively-move-or-copy-files
 [25]: https://github.com/pressbooks/pressbooks/commit/52b087b5e2185ea08c6f67c24111ad9ef0ee1fa0
 [26]: https://wordpress.org/news/2017/03/wordpress-4-7-3-security-and-maintenance-release/
 [27]: https://wordpress.org/news/2017/01/wordpress-4-7-2-security-release/
 [28]: https://houndci.com
 [29]: https://wordpress.org/news/2016/12/vaughan/
 [30]: http://www.princexml.com/download/
 [31]: https://www.google.com/get/noto/#sans-deva
 [32]: https://www.google.com/get/noto/#serif-deva
 [33]: https://github.com/pressbooks/pressbooks/commit/7344674f823517ed7eb2fef462a4795f7182ce56
 [34]: https://github.com/pressbooks/pressbooks/commit/4d7ca649ec3b6c05c40e1c5bb8f92beb1de5ea30
 [35]: https://github.com/pressbooks/pressbooks/pull/540/
 [36]: https://hypothes.is
 [37]: https://sourceforge.net/projects/saxon/files/Saxon-HE/
 [38]: http://docs.pressbooks.org/installation
 [39]: http://www.princexml.com/latest/
 [40]: https://www.createspace.com/ServicesWorkflow/ResourceDownload.do?id=1583
 [41]: https://github.com/pressbooks/pressbooks/blob/master/docs/coding-standards.md
 [42]: https://wordpress.org/plugins/wp-quicklatex/
 [43]: https://github.com/BCcampus/pressbooks-textbook/
 [44]: https://wordpress.org/plugins/hypothesis/
 [45]: http://www.princexml.com/doc/properties/prince-pdf-profile/
 [46]: https://github.com/ellisonleao/sharer.js/
 [47]: https://getcomposer.org
 [48]: https://wordpress.org/plugins/pressbooks-mpdf
 [49]: https://github.com/pressbooks/pressbooks-publisher-one/