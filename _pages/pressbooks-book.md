...
layout: page
permalink: >
  https://docs.pressbooks.org/changelogs/pressbooks-book/
published: true
...
- McLuhan 2.7.0 requires [Pressbooks >= 5.6.5](https://github.com/pressbooks/pressbooks/releases/5.6.5).
...
- McLuhan 2.6.0 requires [Pressbooks >= 5.6.0](https://github.com/pressbooks/pressbooks/releases/5.6.0).
