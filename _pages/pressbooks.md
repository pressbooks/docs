...
# Pressbooks 5.0 Changelog

**NOTICE:** Pressbooks >= 5.0.0 requires [WordPress 4.9.2](https://wordpress.org/news/2018/01/wordpress-4-9-2-security-and-maintenance-release/).  
**NOTICE:** Pressbooks >= 5.0.0 requires [Pressbooks Book 2.0.0](https://github.com/pressbooks/pressbooks-book/).  
**NOTICE:** Pressbooks >= 5.0.0 requires that users of our Luther theme install the standalone [Luther theme](https://github.com/pressbooks/pressbooks-luther/).

* **Feature**: Contributors! We’ve added a centralized contributor management tool where you can add contributors who can then be reused throughout your book as authors, editors, translators, reviewers, illustrators, and generic contributors (see [#989](https://github.com/pressbooks/pressbooks/issues/989), [#1017](https://github.com/pressbooks/pressbooks/issues/1017), [#1020](https://github.com/pressbooks/pressbooks/issues/1020), [#1031](https://github.com/pressbooks/pressbooks/issues/1031), [#1033](https://github.com/pressbooks/pressbooks/issues/1033), [#1038](https://github.com/pressbooks/pressbooks/issues/1038), [#1047](https://github.com/pressbooks/pressbooks/issues/1047), and [#1060](https://github.com/pressbooks/pressbooks/issues/1060)).
* **Feature**: Re-Organizing! We’ve overhauled the Organize page, improving the display on mobile devices, and improving accessibility for keyboard navigation and screen reader users (see [#305](https://github.com/pressbooks/pressbooks/issues/305), [#1009](https://github.com/pressbooks/pressbooks/issues/1009), and [#1046](https://github.com/pressbooks/pressbooks/issues/1046)).
* **Feature**: Content Visibility! We’ve made it more intuitive to manage the visibility of your content across web and exports on both the Organize page and the edit screen for individual front matter, chapters and back matter (see [#1017](https://github.com/pressbooks/pressbooks/issues/1017), [#1033](https://github.com/pressbooks/pressbooks/issues/1033), [#1046](https://github.com/pressbooks/pressbooks/issues/1046), [#1060](https://github.com/pressbooks/pressbooks/issues/1060), and [#1067](https://github.com/pressbooks/pressbooks/issues/1067)).
* **Feature**: Chapter Importing! We’ve added support for importing individual chapters from Pressbooks webbooks using the Import tool. We’ve also added support for importing all supported file types from local (upload) or remote (web-based) sources (see [#1054](https://github.com/pressbooks/pressbooks/issues/1054) and [#1057](https://github.com/pressbooks/pressbooks/issues/1057)).
...
* **Core Enhancement**: We’ve moved the Ebook start point setting to the Ebook Theme Options page to ensure that only one front matter, chapter, or back matter can be set as the Ebook start point (see [#1046](https://github.com/pressbooks/pressbooks/issues/1046) and [#1053](https://github.com/pressbooks/pressbooks/issues/1053)).
...
* **Core Enhancement**: We’ve added a routine to support Luther’s migration to a standalone theme (see [#986](https://github.com/pressbooks/pressbooks/issues/986) and [#1016](https://github.com/pressbooks/pressbooks/issues/1016)).
...
* **Core Enhancement**: We've moved license types into a taxonomy (see [#989](https://github.com/pressbooks/pressbooks/issues/989), [#1010](https://github.com/pressbooks/pressbooks/issues/1010), [#1033](https://github.com/pressbooks/pressbooks/issues/1033), [#1040](https://github.com/pressbooks/pressbooks/issues/1040), [#1044](https://github.com/pressbooks/pressbooks/issues/1044), and [#1066](https://github.com/pressbooks/pressbooks/issues/1066)).
...
* **Core Enhancement**: We’ve updated to version 0.7.1 of the [scssphp](https://github.com/leafo/scssphp) library (see [#1001](https://github.com/pressbooks/pressbooks/issues/1001)).
